...
public class CaptureActivity extends AppCompatActivity {
    ...
    private CheckBox checkBoxIcmp;
    private CheckBox checkBoxIgmp;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        checkBoxTcp = findViewById(R.id.checkBoxTcp);
        checkBoxUdp = findViewById(R.id.checkBoxUdp);
        checkBoxIcmp = findViewById(R.id.checkBoxIcmp);
        checkBoxIgmp = findViewById(R.id.checkBoxIgmp);
        ...
        checkBoxAll.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
           ...
           public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               ...
               if (isChecked) {
                   checkBoxIcmp.setChecked(false);
                   checkBoxIcmp.setEnabled(false);

                   checkBoxUdp.setChecked(false);
                   checkBoxUdp.setEnabled(false);

                   checkBoxTcp.setChecked(false);
                   checkBoxTcp.setEnabled(false);

                   checkBoxIgmp.setChecked(false);
                   checkBoxIgmp.setEnabled(false);


               } else {
                   checkBoxIcmp.setEnabled(true);
                   checkBoxUdp.setEnabled(true);
                   checkBoxTcp.setEnabled(true);
                   checkBoxIgmp.setEnabled(true);
               }
           }
       }
        );
